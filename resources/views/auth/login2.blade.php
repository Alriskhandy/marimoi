...
<body class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden"
    style="background: url('{{ asset('frontend/img/hero2.png') }}') no-repeat center center / cover">
    ...
    <div class="w-full max-w-md z-10">
        ...
        <div
            ...
            <div class="text-center">
                <h2 class="text-3xl font-bold bg-gradient-to-r from-blue-800 to-blue-600 bg-clip-text text-transparent">
                    Selamat Datang</h2>
            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            type="email" id="email" name="email" placeholder="Input Email" required autofocus
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <label class="ml-2 text-gray-600 text-sm" for="remember">Ingat Saya</label>
                    </div>
                    <a href="#"
                        class="text-sm text-blue-600 hover:text-blue-800 font-medium transition-colors duration-200">Lupa
                        Password?</a>
                </div>
