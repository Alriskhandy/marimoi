...
<section class="relative w-full py-20 lg:py-24 bg-white" id="aspirasi">
    <div class="container max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div class="order-2 lg:order-1 flex flex-col gap-6 items-center lg:items-start border-gray-500">
                <!-- Counters -->
                <h2@
            ...
            <div class="order-1 lg:order-2 flex flex-col gap-6 text-center lg:text-right lg:items-start">
                <h2
                    class="text-3xl md:text-3xl lg:text-5xl font-bold text-gray-900 font-[Poppins] leading-tight tracking-tight">
                    Pengunjung MARIMOI
                </h2>
                ...
                <div class="wrapper w-full max-w-4xl mx-auto">
                    ...
                    @foreach ($visitorItems as $item)
                        <div
                            ...
                            <input type="radio" name="faq" id="faq-{{ $item['key'] }}" class="hidden peer">
                            <label for="faq-{{ $item['key'] }}"
                                ...
                                <h3 class="pr-4 md:pr-0 flex items-center">
                                    <i class="bi bi-{{ $item['icon'] }} me-2 animate-pulse"></i>
                                    {{ $item['label'] }}
                                </h3>
                                <span
