                ...
                <div
                    ...
                    <div class="w-full h-[280px] sm:h-[300px] md:h-[320px] lg:h-[450px]">
                        <model-viewer src="{{ asset('frontend/models/peta-sofifi.glb') }}"
                            ...
                            interaction-prompt="none" loading="lazy" class="w-full h-full bg-transparent">

                            <!-- Loading text -->
                            <div slot="poster"
                                class="bg-transparent flex items-center justify-center flex-col text-[var(--primary)] font-[DM_Mono,monospace] h-full">
                                <div>
