@extends('backend.partials.main', ['title' => 'Input Peta PSD'])
...
@section('main')
    <div class="page-header">
        <h3 class="page-title">
            ...
            Data Spasial Peta Proyek Strategis Daerah
        </h3>
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="#!">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">
                    <span></span>Data Spasial Peta Proyek Strategis Daerah <i
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <form method="POST" action="{{ route('psd.store') }}" enctype="multipart/form-data" id="gisForm">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="kategori_id" id="kategori" class="form-select custom-select"
                                            required>
