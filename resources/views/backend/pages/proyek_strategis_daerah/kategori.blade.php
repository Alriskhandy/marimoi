...
@section('main')
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span> Kategori Proyek Strategis Daerah
        </h3>
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('psd.index') }}">Proyek Strategis Daerah</a>
                </li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="card-title">Daftar Kategori Proyek Strategis Daerah</h4>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">
                        <i class="mdi mdi-plus"></i> Tambah Kategori PSD
                    </h5>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">
                        <i class="mdi mdi-pencil"></i> Edit Kategori PSD
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="editForm">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="showModalLabel">
                        <i class="mdi mdi-eye-outline me-1"></i> Detail Kategori PSD
                    </h5>
    ...
    <script>
        ...
        `;
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get(`{{ route('kategori-psd.index') }}/${id}/edit`, function(data) {
                    if (data.success) {
            ...
            $('#editForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `{{ route('kategori-psd.index') }}/${id}`,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '.btn-show', function() {
                ...
                $.get(`{{ route('kategori-psd.index') }}/${id}`, function(data) {
                    if (data.success) {
