@extends('backend.partials.main', ['title' => 'Edit Peta Pokir DPRD'])
@push('styles')
    <style>
        #geom {
            user-select: none;
...
@section('main')
    ...
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Form Edit Lokasi Pokir DPRD</h4>
                    ...
                    <form action="{{ route('usulan-musrenbang.update', $lokasi->id) }}" method="POST" id="lokasiForm">
                        @csrf
                        @method('PUT')
