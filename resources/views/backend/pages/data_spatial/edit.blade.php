@extends('backend.partials.main', ['title' => 'Edit Peta '])
@push('styles')
    <style>
        #geom {
            user-select: none;
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('deskripsi') is-invalid @enderror"
                                        id="deskripsi" name="deskripsi" value="{{ old('deskripsi', $data->deskripsi) }}"
                            ...
                            <div class="col-12">
                                <div class="card mt-4">
                                    <div class="card-header">
                                        <h5 class="mb-0">
                                            <i class="mdi mdi-image"></i> Gambar Lokasi
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="image-preview-placeholder text-center text-muted"
                                                    id="imagePlaceholder">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="btn-group">
                                    {{-- <button type="button" class="btn btn-sm btn-outline-secondary"
                                        id="toggleAttributesView">
                                        <i class="mdi mdi-code-json"></i> Toggle JSON View
                                    </button> --}}
                                    <button type="button" class="btn btn-sm btn-outline-info" id="addNewAttribute">
                            ...
                            <div class="card-body">
                                ...
                                <div id="attributesJsonView" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="dbf_attributes_json" rows="15" style="font-family: monospace;">{{ json_encode($data->dbf_attributes, JSON_PRETTY_PRINT) }}</textarea>
                                        <small class="form-text text-muted">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('geom') is-invalid @enderror" id="geom" name="geom" rows="6"
                                        style="font-family: monospace;" placeholder="POLYGON((lng lat, lng lat, ...))" required readonly>{{ old('geom', $data->geom) }}</textarea>
                                    @error('geom')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            let dbfAttributes = @json($data->dbf_attributes ?? []);
            ...
            $('#lokasiForm').off('submit').on('submit', function(e) {
                e.preventDefault();
                ...
                if (!kategori || !geom) {
                    showAlert(kategori ? 'Geometri harus diisi!' : 'Kategori harus dipilih!', 'danger');
                    $('#loadingOverlay').hide();
                    $('#submitBtn').prop('disabled', false);
                    return;
                }

                // Kirim form secara AJAX agar _method PUT tetap terbaca Laravel
                this
                    .submit(); // ← ini akan menghormati @method('PUT') jika tidak ada JS framework lain yg mengubah behavior
            });
