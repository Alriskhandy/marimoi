                        ...
                        <div class="col-md-3 stretch-card grid-margin">
                            <div class="card bg-gradient-warning card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h4 class="font-weight-normal mb-3">
                                        Dengan Warna
                                        <i class="mdi mdi-palette mdi-24px float-end"></i>
                                    </h4>
                                    <h2 class="mb-5">
                                        {{ $parentKategoris->whereNotNull('warna')->count() + collect($childKategoris)->flatten()->whereNotNull('warna')->count() }}
                                    </h2>
                                    <h6 class="card-text">Kategori berwarna</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover" id="kategoriTable">
                            ...
                            <tbody>
                                ...
                                @forelse($parentKategoris as $kategori)
                                    {{-- Parent --}}
                                    <tr class="table-light" data-id="{{ $kategori->id }}">
                                        <td>{{ $no++ }}</td>
                                    ...
                                    @if (isset($childKategoris[$kategori->id]) && $childKategoris[$kategori->id]->count() > 0)
                                        @foreach ($childKategoris[$kategori->id] as $child)
                                            <tr class="table-secondary" data-id="{{ $child->id }}">
                                                <td>{{ $no++ }}</td>
                                                <td>
                    ...
                    if (data.success) {
                        ...
                        if (kategori.children && kategori.children.length > 0) {
                            ...
                            $.each(kategori.children, function(index, child) {
                                childrenHtml +=
                                    `<span class="badge badge-info me-1 mb-1"><i class="mdi mdi-layers"></i> ${child.nama}</span>`;
                            });
