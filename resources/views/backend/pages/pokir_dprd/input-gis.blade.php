@extends('backend.partials.main', ['title' => 'Input Peta Pokir DPRD'])
...
@section('main')
    <div class="page-header">
        <h3 class="page-title">
            ...
            Data Spasial Peta Pokir DPRD
        </h3>
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="#!">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">
                    <span></span>Data Spasial Peta Pokir DPRD <i
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <form method="POST" action="{{ route('pokir-dprd.store') }}" enctype="multipart/form-data"
                        id="gisForm">
                        @csrf
