...
class KategoriMusrenbangController extends Controller
{
    ...
    {
        $kategori_pokir_dprds = KategoriMusrenbang::with('parent', 'children')->orderBy('nama')->get();
   ...
   public function create()
{
    ...
    public function store(Request $request)
    {
        ...
        $kategori_pokir_dprd = KategoriMusrenbang::create($request->all());
     ...
     */
    public function show(KategoriMusrenbang $kategori_pokir_dprd)
    {
     ...
     */
    public function edit(KategoriMusrenbang $kategori_pokir_dprd)
    {
    $parentKategori = KategoriMusrenbang::where('id', '!=', $kategori_pokir_dprd->id)
    ->orderBy('nama')
    ->get();
     ...
     */
    public function update(Request $request, KategoriMusrenbang $kategori_pokir_dprd)
    {
        $validator = Validator::make($request->all(), [
            'nama' => 'required|string|max:255',
            'deskripsi' => 'nullable|string',
     ...
     */
    public function destroy(KategoriMusrenbang $kategori_pokir_dprd)
    {
        try {
