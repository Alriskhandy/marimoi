...
class KategoriPSD extends Model
{
    use HasFactory;

    protected $table = 'kategori_psd';
    ...
    {
        return $this->belongsTo(KategoriPSD::class, 'parent_id');
    }

    // Relasi untuk child categories
    public function children()
    {
        return $this->hasMany(KategoriPSD::class, 'parent_id');
    }

    // ✅ PERBAIKAN: Relasi dengan ProyekStrategisDaerah
    // Nama method harus sesuai dengan nama model (snake_case untuk relasi hasMany)
    public function proyek_strategis_daerahs()
    {
        return $this->hasMany(ProyekStrategisDaerah::class, 'kategori_id');
    }
    ...
    public function proyekStrategisDaerah()
    {
        return $this->hasMany(ProyekStrategisDaerah::class, 'kategori_id');
    }
